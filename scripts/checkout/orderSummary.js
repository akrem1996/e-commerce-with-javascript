...
import { renderPaymenetSummary } from './paymentSummary.js';
            ...
            const dateString= deliveryDate.format('dddd, MMMM D')
                ...
                cartSummaryHtml += `
                        ...
                        <div class="cart-item-details">
                            ...
                            <span class="delete-quantity-link link-primary js-delete-link js-delet-link-${matchingProduct.id}" data-product-id="${matchingProduct.id}">
                                Delete
                            </span>
                            </div>
                        </div>
